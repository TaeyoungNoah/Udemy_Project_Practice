...
public class UserDao {
    ...
    public int deleteUser(PatchUserReq patchUserReq) {
        String modifyUserNameQuery = "update User set status = ? where userIdx = ? "; // 해당 userIdx를 만족하는 User를 해당 nickname으로 변경한다.
        Object[] modifyUserNameParams = new Object[]{'D', patchUserReq.getUserIdx()}; // 주입될 값들(status, userIdx) 순
