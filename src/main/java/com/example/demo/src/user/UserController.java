...
//    @GetMapping("/b") // (GET) 127.0.0.1:9000/app/users
//    // GET 방식의 요청을 매핑하기 위한 어노테이션
//    public BaseResponse<List<GetUserRes>> getUsersByNickname(@RequestParam(required = true) String nickname) {
...
//    @ResponseBody
//    @GetMapping("/c")
//    public BaseResponse<List<GetUserRes>> getUsersByEmail(@RequestParam(required = true) String email) {
//        try {
//            if (!isRegexEmail(email)) {
//                return new BaseResponse<>(POST_USERS_INVALID_EMAIL);
//            }
